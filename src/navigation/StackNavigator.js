...
import CadastroEvidenciaScreen from '../screens/CadastroEvidenciaScreen'; // Corrigido o nome do import
...
export default function StackNavigator() {
  return (
    <Stack.Navigator initialRouteName="Login">
      ...
      <Stack.Screen name="CadastroEvidencia" component={CadastroEvidenciaScreen} />
